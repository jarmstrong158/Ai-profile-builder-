...
const profile1 = generateProfile(tc1, zones1, arch1, devs1);
...
const profile3 = generateProfile(tc3, zones3, arch3, devs3);
...
const profile5 = generateProfile(tc5, zones5, arch5, devs5);
...
const profile1text = generateProfile(tc1, zones1, arch1, devs1);
