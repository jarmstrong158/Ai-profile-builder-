...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)' }}>
      <header className="fixed top-0 left-0 right-0 h-12 z-40" style={{ backgroundColor: 'var(--color-bg)' }}>
        <div className="h-full flex items-center justify-between px-4 max-w-[960px] mx-auto">
          <button
            onClick={() => navigate('/')}
      ...
      <main className="pt-12 px-4 pb-8 max-w-[960px] mx-auto">
        {children}
      </main>
