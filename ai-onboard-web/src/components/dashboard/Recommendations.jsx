...
export default function Recommendations({ recommendations, teamHealth, members, pairingSuggestions, actions, teamId, onActionsChange, onScheduleTest, onApproveRetake }) {
  const { user } = useAuth();
      ...
      {hasActions && (
        <div>
          ...
          <ActionPanel
            ...
            onApproveRetake={onApproveRetake}
            updating={updating}
          />
        </div>
      )}
